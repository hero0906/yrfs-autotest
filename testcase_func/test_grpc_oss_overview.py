...
class TestGrpcOssOverview(YrfsCli):
    ...
    def teardown_class(self):
        self.sshclient1.ssh_exec("rm -fr %s/grpc_oss_overview_file" % consts.MOUNT_DIR)
    ...
    def test_overview(self):
        ...
        fio_cmd = "nohup fio -iodepth=32 -numjobs=4 -bs=1M -size=50M -rw=rw -time_based -runtime=20 " \
                  "-filename=%s/grpc_oss_overview_file -ioengine=psync -group_reporting " \
        ...
        with grpc.insecure_channel(self.endpoint) as channel:
            ...
            rsp = stub.OssOverview(agent_pb2.OssOverviewPara())
