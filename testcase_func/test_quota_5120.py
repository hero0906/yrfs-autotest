...
class TestquotaUpperlimit(YrfsCli):
    ...
    def test_update_5120(self):
        ...
        test_predir = "autotest_quota_" + time.strftime("%m-%d-%H%M%S")
        ...
        try:
            ...
            for num in range(1, nums):
                testdir = test_predir + "/dir%s" % str(num)
            ...
            sshserver.ssh_exec("rm -fr %s" % os.path.join(consts.MOUNT_DIR, test_predir))
