...
class CreateExhaustiveVM(object):
    ...
    def run(self):
        ...
        if not self.standard_network:
            ...
            self.standard_network2 = network_helper.get_standard_network_backing(
                self.client,
                std_portgroup2_name,
                datacenter_name)
        ...
        * BootDevice order: CDROM, DISK, ETHERNET
        ...
        vm_create_spec = VM.CreateSpec(
            ...
            cpu=Cpu.UpdateSpec(count=8,
                               cores_per_socket=1,
                               hot_add_enabled=False,
                               hot_remove_enabled=False),
            memory=Memory.UpdateSpec(size_mib=16 * GiBMemory,
                                     hot_add_enabled=False),
            disks=[
            ...
            nics=[
                ...
                Ethernet.CreateSpec(
                    ...
                    type = "VMXNET3",
                    #mac_address='11:23:58:13:21:35',
                    backing=Ethernet.BackingSpec(
                        #type=Ethernet.BackingType.DISTRIBUTED_PORTGROUP,
                        type=Ethernet.BackingType.STANDARD_PORTGROUP,
                        network=self.standard_network2)),
