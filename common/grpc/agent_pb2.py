...
GetSlaInfoPara = _reflection.GeneratedProtocolMessageType('GetSlaInfoPara', (_message.Message,), dict(
...
GetSlaInfoRet = _reflection.GeneratedProtocolMessageType('GetSlaInfoRet', (_message.Message,), dict(
